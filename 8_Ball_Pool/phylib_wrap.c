...
SWIGINTERN PyObject *_wrap_coord_distance(PyObject *self, PyObject *args) {
  PyObject *resultobj = 0;
  phylib_coord arg1 ;
  phylib_coord arg2 ;
  void *argp1 ;
  ...
  if (!SWIG_Python_UnpackTuple(args, "coord_distance", 2, 2, swig_obj)) SWIG_fail;
  {
    res1 = SWIG_ConvertPtr(swig_obj[0], &argp1, SWIGTYPE_p_phylib_coord,  0 );
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "coord_distance" "', argument " "1"" of type '" "phylib_coord""'"); 
    }  
    if (!argp1) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "coord_distance" "', argument " "1"" of type '" "phylib_coord""'");
    } else {
      arg1 = *((phylib_coord *)(argp1));
    }
  }
  {
    res2 = SWIG_ConvertPtr(swig_obj[1], &argp2, SWIGTYPE_p_phylib_coord,  0 );
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), "in method '" "coord_distance" "', argument " "2"" of type '" "phylib_coord""'"); 
    }  
    if (!argp2) {
      SWIG_exception_fail(SWIG_ValueError, "invalid null reference " "in method '" "coord_distance" "', argument " "2"" of type '" "phylib_coord""'");
    } else {
      arg2 = *((phylib_coord *)(argp2));
    }
  }
  result = (double)coord_distance(arg1,arg2);
  resultobj = SWIG_From_double((double)(result));
  return resultobj;
fail:
  return NULL;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "coord_distance", _wrap_coord_distance, METH_VARARGS, NULL},
